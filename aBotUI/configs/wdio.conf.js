exports.config = {
    ...
    screenshotPath: '{aBotErrorShotPath}',
    //
    ...
    reporters: ['json'],
    reporterOptions: {
        outputDir: '{aBotJsonReportOutputDirPath}'
    },
    //
    ...
    before: function (capabilities, specs) {
        ...
        global.waitMS = function (milliseconds) {
            var startTime = new Date();
            var currentTime = null;
            var msCount = 0;
            while (msCount < milliseconds) {
                currentTime = new Date();
                msCount = currentTime - startTime;
            }
        };
